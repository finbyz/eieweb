...
def get_items(filters=None, search=None):
	...
	if search:
		...
		default_fields = {'name', 'item_name', 'description', 'item_group', 'website_item_name'}
...
def get_context(context):
	...
	context.field_filters = get_products_for_website(field_filters, attribute_filters,search)
