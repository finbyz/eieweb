var isOpened = false;
$('#campaign_enquire_btn').on('click', function () {
    isOpened = true;
    if ($("#inquiry-form-section").hasClass('slide-right active')) {
        $('#inquiry-form-section').removeClass('active').toggleClass('slide-right');
    }
    else if ($("#inquiry-form-section").hasClass('active')) {
        $('#inquiry-form-section').removeClass('active');
    }
    // toggle class on click contact button
    else if ($("#inquiry-form-section").hasClass('slide-right')) {
        $('#inquiry-form-section').toggleClass('slide-right');
    }
    else {
        $('#inquiry-form-section').toggleClass('slide-right');
    }
    if ($('#inquiry-form-section').hasClass('slide-right')) {
        setTimeout(function () {
...
//active form at certain height 
$(function () {
    $(window).scroll(function () {
        var scroll = $(window).scrollTop();

        if (scroll >= 2000 && !isOpened) {
            isOpened = true;
            $("#inquiry-form-section").addClass("slide-right");
        }
        if ($('#inquiry-form-section').hasClass('slide-right')) {
            setTimeout(function () {
                $('#rightArrow').removeClass('active');
 ...
 * Original files:
 * - /gh/finbyz/eieweb@master/eieweb/public/js/owl.carousel.min.js
 * - /npm/gsap@3.6.0/dist/gsap.min.js
 * - /gh/finbyz/eieweb@master/eieweb/public/js/combine.min.js
 *
...
addCssSpeed:function(a){return{"-webkit-transition":"all "+a+"ms ease","-moz-transition":"all "+a+"ms ea    se","-o-transition":"all "+a+"ms ease",transition:"all "+a+"ms ease"}},removeTransition:function(){return{"-webkit-transition":"","-moz-transition":"","-o-transition":"",transition:""}},doTranslate:function(a){return{"-webkit-transform":"translate3d("+a+"px, 0px, 0px)","-moz-transform":"translate3d("+a+"px, 0px, 0px)","-o-transform":"translate3d("+a+"px, 0px, 0px)","-ms-transform":"translate3d("+
...
//# sourceMappingURL=/sm/c06f7651101146ab3eac744038ebbf74b04b7bb9e6b7fcfb145f5a5bfeca46f6.map
...
// code for content over the image in home page
